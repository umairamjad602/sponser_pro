...
<body>
   ...
   @include('dashboard.modals.registration-modal')
    ...
    <!-- header -->
    <div style="background-image: url({{ asset('front-end/images/brands.png') }});"
        ...
        <div class="container-fluid  hero-section  sec-space">
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h2><span style="color:white;">HOW IT WORKS ></span>BRANDS
                        </h2>
                        <h1 class="">Take Your Brand to <br>Icon Status</h1>
                        <p>Instantly connect with athlete influencers of all types to boost your <br> visibility.</p>
                        <a href="" class="btn  bg-green-btn d-flex align-items-center my-2" type="button" style="width:250px;">
										<div class="text-start">BRAND SIGN UP</div>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center gy-4">
                <div class="col-md-8 col-sm-12">
                    ...
                    <h3>The Power of Athlete Influencers at Your Fingertips
    ...
    <div class="container-fluid sec-space how-it-works-img-text-col" style=" background-image: url({{ asset('front-end/images/01.png') }});">
        <div class="container">
            <div class="row g-5 d-flex align-items-center justify-content-center" >
                ...
                <div class="col-lg-6 col-12">
                    <img src="{{ asset('front-end/images/brand-create-account.png') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
      ...
      <div class="container-fluid sec-space how-it-works-img-text-col " style=" background-image: url({{ asset('front-end/images/02.png') }}); background-position:top center;">
        <div class="container">
            <div class="row g-5 d-flex align-items-center justify-content-center" >
            <div class="col-lg-6 col-12">
                    <img src="{{ asset('front-end/images/brand-negotiate.png') }}" alt="" class="img-fluid">
                </div>

                <div class="col-lg-6 col-12 ">
                    <h2 class="pb-2">Negotiate Contracts</h2>
                 <p>A professional athlete or their agent quickly builds a profile citing the athlete’s passions, hobbies, rate, etc. Once live, brands can search for you in our marketplace and reach out to start a conversation about endorsements. All potential brand deals can be viewed in your dashboard.</p>
      ...
      <div class="container-fluid sec-space how-it-works-img-text-col " style=" background-image: url({{ asset('front-end/images/03.png') }});">
        <div class="container">
            <div class="row g-5 d-flex align-items-center justify-content-center">
               ...
               <p>As soon as both you and the brand are satisfied with the terms, you sign and receive payment through our encrypted technology. Athletes always get paid before executing their side of a deal.</p>
                ...
                <div class="col-lg-6 col-12">
                    <img src="{{ asset('front-end/images/brand-sign-execute.png') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid  sec-space " style=" background-image: url({{ asset('front-end/images/light-green-bg.png') }});">
        <div class="container">
           <div class="row g-5 ">
              <div class="col-12 ">
                    <p>BRANDS</p>
                    <h2 class="main-heading">Experience Uninhibited Brand Growth <br> Without the Growing Pains</h2>
                </div>
