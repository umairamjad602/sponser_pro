...
<body>
   ...
   @include('dashboard.modals.registration-modal')
    ...
    <!-- header -->
    <div style="background-image: url({{ asset('front-end/images/clg-athletes.png') }});"
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{url('professional-athletes')}}">PROFESSIONAL ATHLETES</a></li>
        ...
        <div class="container-fluid  hero-section  sec-space">
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h2><span style="color:white;">HOW IT WORKS ></span> COLLEGE ATHLETES
                        </h2>
                        <h1 class="">Seize the Power of Your <br> College NIL</h1>
                        <p>Free access to career-boosting brand partnerships.</p>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center gy-4">
                <div class="col-md-8 col-sm-12">
                    ...
                    <h3>College Athlete Endorsements of All Types are Waiting for You on Icon Source.
        ...
        <div class="container">
           <div class="row g-5 ">
              <div class="col-12 ">
                    ...
                    <h2 class="main-heading">Playing a Sport is Hard Enough.<br>
Deals Should be Easy.</h2>
                </div>
