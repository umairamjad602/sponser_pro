...
<body>
   ...
   @include('dashboard.modals.registration-modal')
    ...
    <!-- header -->
    <div style="background-image: url({{ asset('front-end/images/professional-athletes.png') }});"
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="uni-athletic-departments">UNIVERSITIES & ATHLETIC DEPARTMENTS</a></li>
        ...
        <div class="container-fluid  hero-section  sec-space">
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h2><span style="color:white;">HOW IT WORKS ></span>  PROFESSIONAL ATHLETES
                        </h2>
                        <h1 class="">The Easiest Way to Get <br> Brand Deals</h1>
                        <p>Maximize brand visibility by joining the premier professional athlete <br> sponsorship marketplace.</p>
                        <a href="" class="btn  bg-green-btn d-flex align-items-center my-2" type="button" style="width:250px;">
										<div class="text-start">ATHLETE SIGN UP</div>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center gy-4">
                <div class="col-md-8 col-sm-12">
                    ...
                    <h3>Get Your Head in the Game of Professional Athlete Endorsements
    ...
    <div class="container-fluid sec-space how-it-works-img-text-col" style=" background-image: url({{ asset('front-end/images/01.png') }});">
        <div class="container">
            <div class="row g-5 d-flex align-items-center justify-content-center" >
                ...
                <div class="col-lg-6 col-12 " >
                    <h2 class="pb-2">Create an Account</h2>
                   <p>Let brands know who you are by creating a free profile on our platform in minutes, filling in things like your interests, sport, and social media profiles. All potential brand deals can be viewed in your dashboard.</p>
      ...
      <div class="container-fluid sec-space how-it-works-img-text-col " style=" background-image: url({{ asset('front-end/images/02.png') }}); background-position:top center;">
        <div class="container">
            <div class="row g-5 d-flex align-items-center justify-content-center" >
            <div class="col-lg-6 col-12">
                    <img src="{{ asset('front-end/images/negotiate-contracts.png') }}" alt="" class="img-fluid">
                </div>

                <div class="col-lg-6 col-12 ">
                    <h2 class="pb-2">Negotiate Contracts</h2>
                   <p>After creating an account, potential brand partners can view your profile and you can browse their available campaigns. After a brand finds you, or you find them, either party can reach out to start a conversation.</p>
      ...
      <div class="container-fluid sec-space how-it-works-img-text-col " style=" background-image: url({{ asset('front-end/images/03.png') }});">
        <div class="container">
            <div class="row g-5 d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-6 col-12 ">
                    <h2 class="pb-2">Sign and Execute</h2>
                   <p>All potential deals can be viewed in your dashboard, where you can negotiate contract terms. After negotiation, simply sign and receive payment through our secure platform. Once you’re paid, you are free to execute the terms of your deal.</p>
        ...
        <div class="container">
           <div class="row g-5 ">
              <div class="col-12 ">
                    ...
                    <h2 class="main-heading">Brand Deals Easier Than a <br> Layup</h2>
                </div>
            ...
            <img src="{{ asset('front-end/images/access.png') }}" alt="" class="img-fluid mb-3">
            <h6>Accessibility</h6>
            ...
            <div class="col-md-4 text-center  how-it-works-cards-bg" style=" background-image: url({{ asset('front-end/images/green-vector.png') }});">
            <div class="how-it-works-cards">
            <img src="{{ asset('front-end/images/customization.png') }}" alt="" class="img-fluid mb-3">
            <h6>Customization</h6>
            <p>Work together with brands to build contracts that best suit your interests and abilities.</p>
            </div>
            </div>
